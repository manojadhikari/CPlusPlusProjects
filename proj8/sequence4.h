...
// sequence1 (with a fixed array) and sequence2 (with a dynamic array) and sequence 3.
// This is a template for sequence class.
//
...
//   iterator begin( )
//      Postcondition: An iterator at the beginning of the list is returned

//   const_iterator begin( ) const
//      Postcondition: A constant iterator at the front of the list is returned.

//   iterator end( )
//      Postcondition: An iterator at the end of the list is returned.

//   const iterator end( ) const
//      Postcondition: A constant iterator at the end of the list is returned.
//
...
namespace scu_coen70_6B
{
    ...
    //  2. For an empty sequence, we do not care what is stored in any of data and head_ptr and tail_ptr point to NULL; for a non-empty sequence, the items stored in the sequence can be accessed using head_ptr and tail_ptr and we don't care what is stored in the rest of the data.
    
    //  3. If there is a current item, then it lies in *cursor; if there is no current item, then cursor* equals NULL.
    
    //  4. If there is a previous item, then it lies in precursor*.  If there is no previous item, then precursor equals NULL.
